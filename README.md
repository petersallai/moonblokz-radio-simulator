...
The primary purpose of this application is to simulate and visualize the radio communication layer of the MoonBlokz network. The simulation operates using the same radio logic as the embedded nodes. It displays a 2D map featuring nodes and obstacles, simulates radio signal propagation and potential collisions, and allows you to observe metrics such as throughput, link quality, and distribution in real time. Additionally, a scalable virtual-time driver enables simulations to be accelerated or slowed without causing timer bursts or stalls.
